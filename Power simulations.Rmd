...
```{r}
# Running this might cause a system dialogue to allow R to accept incoming network connections. 
# I denied this request, which might affect the behavior of future. 
options(mc.cores = 4)
